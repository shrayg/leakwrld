-- Consolidation pass: remove unused product schema and user/profile duplication.
...
-- Drop legacy FK columns that force old profile/category model.
alter table if exists public.videos drop column if exists owner_id;
alter table if exists public.videos drop column if exists category_id;
alter table if exists public.comments drop column if exists author_id;
alter table if exists public.comment_reactions drop column if exists user_id;
alter table if exists public.video_reactions drop column if exists user_id;
alter table if exists public.view_events_raw drop column if exists viewer_id;
alter table if exists public.age_gate_events drop column if exists user_id;
