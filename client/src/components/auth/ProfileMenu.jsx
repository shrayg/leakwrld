  ...
  return (
    <div className="profile" id="profile" ref={rootRef}>
      ...
      <div className={'profile-dropdown' + (menuOpen ? ' active' : '')} id="profile-dropdown" role="menu" aria-label="Profile menu">
        ...
        <a href={OFFICIAL_DISCORD_INVITE_URL} className="profile-contact" role="menuitem" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)}>
          Discord (official)
        </a>
        <a href={OFFICIAL_TELEGRAM_URL} className="profile-contact" role="menuitem" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)}>
          Telegram (official)
        </a>
