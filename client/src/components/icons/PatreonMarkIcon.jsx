/** Patreon logomark (geometry aligned with Simple Icons). Renders white on Patreon coral (#FF424D) backgrounds. */
export function PatreonMarkIcon({ size = 18, className }) {
  return (
    <svg
      className={className}
      width={size}
