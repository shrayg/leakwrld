...
export function AuthModal() {
  ...
  return (
    <div className="auth-overlay active" id="auth-overlay" aria-hidden="false" role="presentation" onClick={(e) => e.target === e.currentTarget && closeAuth()}>
      <div className="auth-modal" role="dialog" aria-modal="true" aria-labelledby="auth-title" onClick={(e) => e.stopPropagation()}>
        ...
        {authTab === 'login' ? (
          <form className="auth-form" id="auth-login" onSubmit={onLogin}>
            ...
            <label>
              <span>Password</span>
              <input name="password" type="password" autoComplete="current-password" required minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} />
            </label>
          ...
          <form className="auth-form" id="auth-signup" onSubmit={onSignup}>
            <label>
              <span>Username</span>
              <input name="username" autoComplete="username" required minLength={3} value={username} onChange={(e) => setUsername(e.target.value)} />
            </label>
            ...
            <label>
              <span>Password</span>
              <input name="password" type="password" autoComplete="new-password" required minLength={8} value={password} onChange={(e) => setPassword(e.target.value)} />
            </label>
            <label>
              <span>Confirm Password</span>
              <input name="password2" type="password" autoComplete="new-password" required minLength={8} value={password2} onChange={(e) => setPassword2(e.target.value)} />
            </label>
            <button className="auth-primary" type="submit">
              Create Account
            </button>
